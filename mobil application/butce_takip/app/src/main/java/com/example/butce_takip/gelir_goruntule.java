...
public class gelir_goruntule extends AppCompatActivity {
    ...
    /*public void onBackPressed() {
        super.onBackPressed();
        String degisken=gelirtoplami.getText().toString();
        Intent intent_yeni=new Intent(gelir_goruntule.this,ana_sayfa.class);
        intent_yeni.putExtra("insallah",degisken);
        startActivity(intent_yeni);
