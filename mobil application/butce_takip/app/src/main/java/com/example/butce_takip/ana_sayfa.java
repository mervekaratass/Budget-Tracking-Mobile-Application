       ...
       Intent intent=getIntent();
        ...
        if(kullad==null)
        {
            ...
            if(kullad2==null)
            {
                ...
                gelirtoplami.setText(String.valueOf(toplam4)+" ₺");
                int gidertoplam4 = DB.Gider_Toplam(kullad4);
                gidertoplami.setText(String.valueOf(gidertoplam4) +" ₺");
            ...
            else
            {
                ...
                gelirtoplami.setText(String.valueOf(toplam2)+" ₺");
                int gidertoplam2 = DB.Gider_Toplam(kullad2);
                gidertoplami.setText(String.valueOf(gidertoplam2) +" ₺");
        ...
        else
        {
            ...
            gidertoplami.setText(String.valueOf(gidertoplam)+" ₺");
